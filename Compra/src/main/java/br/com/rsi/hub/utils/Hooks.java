...
import br.com.rsi.hub.contexto.ContextoTeste;
...
public class Hooks {
	...
	public void capturaCenario(Scenario cenario) {
		...
		try {
			...
			String caminhoDestino = System.getProperty("user.dir") + "/target/cucumber-reports/screenshots/"
					+ screenshotName + "_" + Generator.dataHoraParaArquivo() + ".png";
